...
public:
    ...
    void setupUi(QDialog *AdminPanel)
    {
        ...
        applyButton = new QPushButton(distancesTab);
        applyButton->setObjectName("applyButton");

        horizontalLayout_2->addWidget(applyButton);

        saveExitButton = new QPushButton(distancesTab);
        saveExitButton->setObjectName("saveExitButton");

        horizontalLayout_2->addWidget(saveExitButton);

        cancelButton = new QPushButton(distancesTab);
    ...
    void retranslateUi(QDialog *AdminPanel)
    {
        ...
        applyButton->setText(QCoreApplication::translate("AdminPanel", "Apply Changes", nullptr));
        saveExitButton->setText(QCoreApplication::translate("AdminPanel", "Save and Exit", nullptr));
        cancelButton->setText(QCoreApplication::translate("AdminPanel", "Cancel", nullptr));
