...
"}"));
        ...
        label->setGeometry(QRect(200, 0, 391, 61));
        QFont font;
...
"}"));
        ...
        backgroundImage->setMaximumSize(QSize(801, 611));
    ...
    void retranslateUi(QMainWindow *MainPage)
    {
        ...
        label->setText(QCoreApplication::translate("MainPage", "<html><head/><body><p align=\"center\"> College Campus Touring</p></body></html>", nullptr));
